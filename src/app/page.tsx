...
const lanes = [
  { kicker: "Devices", title: "Laptop repair Nairobi", image: "/images/motherboard-repair.jpg", href: "/services", label: "Find a repair" },
        ...
        <div className="relative mx-auto flex min-h-[650px] max-w-7xl flex-col justify-between gap-16 px-5 py-6 sm:px-8 lg:px-12">
          ...
          <div className="grid items-end gap-12 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="animate-rise-in">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-coral-brand/50 bg-coral-brand/10 px-3 py-1.5 text-xs font-bold text-coral-brand"><Wrench className="h-3.5 w-3.5" />The repair lab that goes deeper</div>
              ...
              <p className="mt-7 max-w-lg text-base leading-7 text-cream-bg/75 sm:text-lg">Board-level repairs, honest diagnostics, and IT support for Nairobi devices and businesses.</p>
